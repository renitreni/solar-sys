...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('vendor/assets/css/kaiadmin.min.css') }}" />
    <link rel="stylesheet" href="{{ asset('vendor/documentation/assets/styles.css') }}" />
    <link rel="stylesheet" href="{{ asset('vendor/documentation/assets/prism-normalize-whitespace.min.js') }}" />
</head>
            ...
            <div class="sidebar-logo">
                ...
                <div class="logo-header" data-background-color="dark">
                    <a href="index.html" class="logo">
                        <img src="{{ asset('vendor/assets/img/kaiadmin/logo_light.svg') }}" alt="navbar brand"
                        ...
                        <ul class="navbar-nav topbar-nav ms-md-auto align-items-center">
                                    ...
                                    <li>
                                        <div class="message-notif-scroll scrollbar-outer">
                                            <div class="notif-center">
                                                <a href="#">
                                                    <div class="notif-img">
                                                        <img src="{{ asset('vendor/assets/img/jm_denis.jpg') }}"
                                                            alt="Img Profile">
                                                    </div>
                                                ...
                                                <a href="#">
                                                    <div class="notif-img">
                                                        <img src="{{ asset('vendor/assets/img/chadengle.jpg') }}"
                                                            alt="Img Profile">
                                                    </div>
                                                    <div class="notif-content">
                                                ...
                                                <a href="#">
                                                    <div class="notif-img">
                                                        <img src="{{ asset('vendor/assets/img/mlane.jpg') }}"
                                                            alt="Img Profile">
                                                    </div>
                                                    <div class="notif-content">
                            ...
                            <li class="nav-item topbar-user dropdown hidden-caret">
                                <a class="dropdown-toggle profile-pic" data-bs-toggle="dropdown" href="#"
                                    aria-expanded="false">
                                    <div class="avatar-sm">
                                        <img src="{{ asset('vendor/assets/img/profile.jpg') }}" alt="..."
                                        ...
                                        <li>
                                            <div class="user-box">
                                                <div class="avatar-lg"><img
                                                        src="{{ asset('vendor/assets/img/profile.jpg') }}"
